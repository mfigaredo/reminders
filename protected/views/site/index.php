...
<div class="col-xs-6 col-sm-3 sidebar-offcanvas">
	...
	<form role="form">
		<div class="form-group">
			...
			<?php echo CHtml::dropDownList('id', array(), CHtml::listData(Locations::model()->findAll(),'id','name'), CMap::mergeArray($selected, array('empty' => 'Select a Location', 'class' => 'form-control'))); ?>
		</div>
	...
	<?php if (!empty($places['results'])): ?>
		...
		<ul class="list-group">
			<?php foreach ($places['results'] as $place): ?>
				<li class="list-group-item"><?php echo $place['name']; ?></li>
				<?php
